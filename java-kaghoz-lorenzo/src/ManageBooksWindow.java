...
public class ManageBooksWindow extends JFrame {
    ...
    private void loadAuthorsCombo() {
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/java-kagholorenzo", "root", "root"); //Connexion a la bdd
    ...
    private boolean checkDuplicateLivre(String titre) {
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/java-kagholorenzo", "root", "root");
